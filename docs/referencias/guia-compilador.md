...
> Documento original fornecido pelo professor, reproduzido na íntegra como referência. A adaptação dessas sprints para as datas oficiais desta equipe está em [Cronograma & Marcos](../cronograma.md) e nas páginas de cada [Sprint](../sprints/sprint-1.md).
